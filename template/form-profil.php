...
<form id="front-end-profil">
  ...
  <fieldset>
    ...
    <label for="user_url">Site web</label>
    <input type="text" name="user_url" id="user_url" value="<?= $user->user_url ?>">
  </fieldset>
  <div>
    <?php wp_nonce_field( 'ys-user-nonce', 'ys-user' ); ?>
    <button type="submit">Enregistrer</button>
    <a href="#" id="delete_account">Supprimer mon compte</a>
  </div>
</form>
<a href="/wp-login.php?action=logout">Se déconnecter</a>